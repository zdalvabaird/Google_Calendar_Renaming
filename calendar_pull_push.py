...
#     api_response_list = []
#     events_list = retrieve_events(num_of_days, source_calendar_id)
#     destination_events = {event['summary']: event for event in retrieve_events(num_of_days, destination_calendar_id)}

#     for event in tqdm(events_list):
#         event_details = get_event_details(event)
#         if modify_event_name and event_details['summary'] in schedule:
#             event_details['summary'] = schedule[event_details['summary']]

#         if event_details['summary'] not in destination_events:
#             api_response = add_event(event_details)
#             api_response_list.append(api_response)
